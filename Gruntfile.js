    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:jdjkelly/bravery.haus.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://jdjkelly.github.io/bravery.haus/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://jdjkelly.github.io/bravery.haus/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://jdjkelly.github.io/bravery.haus/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://jdjkelly.github.io/bravery.haus/'
